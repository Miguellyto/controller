...
$result_filial = "INSERT INTO filial (cod, nome, endereco, bairro, cep, cidade, uf, cell, fonegerancia, statusfilial, created) VALUES ('$cod', '$nome', '$endereco', '$bairro', '$cep', '$cidade', '$uf', '$cell', '$fonegerancia', '$statusfilial', NOW())";
$resultado_filial = mysqli_query($conn, $result_filial);

if(mysqli_insert_id($conn)){
	$_SESSION['msg'] = "<p style='color:green;'>Filial cadastrada com sucesso</p>";
	header("Location: cad_filial.html");
